...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
        // calculateBMI ( weight in kilograms ) , ( height in meters )
        System.out.println("BMI = " + MyUtill.calculateBMI(50 , 1.65));

        System.out.println("Average = " + MyUtill.average(15, 5, 5));
    ...
    static void work04UseOfObjectClass() {
      ...
      */
        ...
        // Create Person
        Person person1 = new Person(90001);
        Person person2 = new Person(90002);
